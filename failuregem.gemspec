Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency 'capistrano', '~> 3.11', '>= 3.11.2'
  ...
  s.add_runtime_dependency 'jquery-rails', '~> 4.3', '>= 4.3.5'
  s.add_runtime_dependency 'simple_form', '~> 5.0', '>= 5.0.1'
  ...
  s.add_runtime_dependency 'devise_ldap_authenticatable', '~> 0.8', '>= 0.8.6'
  ...
  s.add_runtime_dependency 'cancancan', '~> 3.0', '>= 3.0.1'
  s.add_runtime_dependency 'rails_admin', '~> 2.0', '>= 2.0'
  s.add_runtime_dependency 'rails_real_favicon', '~> 0.0.13'
  s.add_runtime_dependency 'font-awesome-rails', '~> 4.7', '>= 4.7.0.5'


  s.add_development_dependency 'capistrano', '~> 3.11', '>= 3.11.2'
